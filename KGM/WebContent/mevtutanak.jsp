...
<body>
 ...
 <!-- Buraya yapıstır -->              
                    <div id="sag">
                    <div class="renk">
                    <div style="padding:5px; color:#FFF; font-family:'Arial'">ONAYLANMAYAN MEVCUT TUTANAKLAR</div></div>
                    <!-- ORTAALAN BAŞLANGIÇ !-->
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
    ...
    <td width="35%" height="30" align="center" valign="middle" bgcolor="#D7D7D7">Duzenleyen</td>
