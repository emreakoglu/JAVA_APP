...
/**
 * Servlet implementation class Mevcutlar
 */
@WebServlet("/mevcutlar")
public class Mevcutlar extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean TRUE = true;
		try {
			preStat = myConnec.prepareStatement("SELECT * FROM tutanak WHERE goruldu="+true);
